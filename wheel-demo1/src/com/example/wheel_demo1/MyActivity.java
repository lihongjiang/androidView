...
import com.example.wheel_demo1.wheel.OnWheelChangedListener;
...
public class MyActivity extends Activity {
    ...
    public void opennum2(View view) {
        View view2 = getLayoutInflater().inflate(R.layout.wheel_num, null);
        final WheelView wheel = (WheelView) view2.findViewById(R.id.wheel1);
        wheel.setAdapter(new NumericWheelAdapter(30, 300));
        wheel.setLabel("cm");
        wheel.setCurrentItem(100);

        final WheelView wheel2= (WheelView) view2.findViewById(R.id.wheel2);
